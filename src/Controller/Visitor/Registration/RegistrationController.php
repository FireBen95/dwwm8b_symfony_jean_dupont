...
class RegistrationController extends AbstractController
{
    ...
    ): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            // Le manager des entités prépare et la requête
    ...
    public function emailVerification(User $user, string $token, UserRepository $userRepository) : Response
    {
        ...
        /*
         * Si l'utilisateur a déjà vérifié son compte,
         * On le redirige vers la page de connexion avec un message flash lui expliquant
         * que son compte est déjà vérifié et qu'il peut maintenant se connecter
        */
        ...
        /*
         * Si l'instant durant lequel, l'utilsateur vérifié son compte est strictement supérieur
        ...
        */
        if ( (new \DateTimeImmutable('now') > $user->getDeadLineForEmailVerification() ) ) 
        {
            ...
            le : $deadline! Veuillez vous réinscrire.", );
        }
